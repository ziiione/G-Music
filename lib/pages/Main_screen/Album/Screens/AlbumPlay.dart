...
import 'package:g_application/pages/Main_screen/Album/widget/Icons_row_item_album.dart';
import 'package:g_application/pages/Main_screen/Album/widget/animationPlayAlbum.dart';
...
import '../widget/PlayPauseNextSuffleAlbum.dart';
import 'package:provider/provider.dart';

class AlbumPlay extends StatelessWidget {
  AlbumPlay({super.key});
  static const routeName = '/AlbumPlay';
                  ...
                  children: [
                    ...
                    GlossyContainer(
                      ...
                      child: Container(
                        ...
                        child: SfreadialgaugeAlbum(provider: provider),
                      ),
                    ),
                    Positioned(
                      left: 10,
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                text11Bold(
                                    text:
                                        '${provider.Albums.length} Playing',
                                    color:
                      ...
                      children: [
                       AnimationPlayAlbum(
                        ...
                        SizedBox(
                         ...
                         IconRowItemAlbum( song: provider.currentSong!,),
                        SliderControlAlbum(provider: provider),
                        TimePlayValueAlbum(provider: provider),
                        const PauseNextLoopSuffleAlbum(),
                      ],
                    ),
                  ],
                ),
